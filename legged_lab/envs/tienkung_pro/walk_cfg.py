...
class ProRewardCfg:
    ...
    body_orientation_l2 = RewTerm(
        func=mdp.body_orientation_l2, params={"asset_cfg": SceneEntityCfg("robot", body_names="pelvis")}, weight=-20.0
    )
...
@configclass
class TienKungProWalkFlatEnvCfg:
    amp_motion_files_display = ["legged_lab/envs/tienkung_pro/datasets/motion_visualization/walk.txt"]
    device: str = "cuda:0"
...
@configclass
class TienKungProWalkAgentCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    ...
    run_name = ""
    logger = "tensorboard"
    neptune_project = "pro_walk"
    wandb_project = "pro_walk"
    resume = False
    load_run = "2026-03-03_15-52-46"
    load_checkpoint = "model_.*.pt"

    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["legged_lab/envs/tienkung_pro/datasets/motion_amp_expert/walk.txt"]
