...
DEX_V3_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{ISAAC_ASSET_DIR}/EVT2/urdf/tiangong2dex.urdf",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "shoulder_pitch_l_joint": 0.2, # l_shoulder_pitch
            "shoulder_roll_l_joint": 0.1,  # l_shoulder_roll
            "shoulder_yaw_l_joint": 0.0,   # l_shoulder_yaw
            "elbow_pitch_l_joint": -0.5,   # l_elbow
            # "elbow_yaw_l_joint": 0.0,      # l_wrist_yaw
            # "wrist_pitch_l_joint": 0.0,    # l_wrist_pitch
            # "wrist_roll_l_joint": 0.0,     # l_wrist_roll
            "shoulder_pitch_r_joint": 0.2, # r_shoulder_pitch
            "shoulder_roll_r_joint": -0.1, # r_shoulder_roll
            "shoulder_yaw_r_joint": 0.0,   # r_shoulder_yaw
            "elbow_pitch_r_joint": -0.5,   # r_elbow
